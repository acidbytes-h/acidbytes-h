...
[![Python, C, C++, C#, HTML, CSS, Java, Bash, Vim, Godot, Markdown](https://skillicons.dev/icons?i=python,c,cpp,cs,html,css,java,bash,vim,godot,md&theme=light)](https://skillicons.dev)
